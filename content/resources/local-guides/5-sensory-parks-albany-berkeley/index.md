...
{{< figure src="ocean-view.jpg" alt="Ocean View Park" class="right" height="200px" >}}
...
*📍 [900 Buchanan St, Albany](https://www.google.com/maps/search/?api=1&query=Ocean+View+Park&query_place_id=ChIJu50sVCx5hYARN5kQerQ-9ys)*

{{< clearfloat >}}

### 2. Adventure Playground (Berkeley Marina)

{{< figure src="adventure-playground.jpg" alt="Adventure Playground" class="right" height="200px" >}}
...
*📍 [160 University Ave, Berkeley](https://www.google.com/maps/search/?api=1&query=Adventure+Playground&query_place_id=ChIJPxoGuyF_hYAR8NRYe5_WJdc)*

{{< clearfloat >}}

### 3. Codornices Park (Berkeley)

{{< figure src="codornices.jpg" alt="Codornices Park" class="right" height="200px" >}}
...
*📍 [1201 Euclid Ave, Berkeley](https://www.google.com/maps/search/?api=1&query=Codornices+Park&query_place_id=ChIJGxW97Rx8hYARrmWBykD0ryE)*

{{< clearfloat >}}

### 4. Castro Park (El Cerrito)

{{< figure src="castro.jpg" alt="Castro Park" class="right" height="200px" >}}
...
*📍 [1420 Norvell St, El Cerrito](https://www.google.com/maps/search/?api=1&query=Castro+Park&query_place_id=ChIJk5CbeTh5hYAR8Ned0EdbCKM)*

{{< clearfloat >}}

### 5. Dracena Quarry Park (Piedmont/Oakland border)

{{< figure src="dracena.jpg" alt="Dracena Quarry Park" class="right" height="200px" >}}
